El tipico ejemplo de paso de parametros por referencia en c suele ser un intercambio<br> entre enteros, al que se podria aÃƒÂ±adir un ejemplo con cadenas de <br>texto que ademas son punteros.
<pre>
/**
* $Id$

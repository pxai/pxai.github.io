<p><strong>Listas en python</strong> Las listas son como arrays, permiten toda clase de tipos, anidaciÃ³n, etc.. el manejo es peculiar. Este es un ejemplo muy simple.</p>
<pre>#!/usr/bin/python
# coding=utf-8
